...
Config.instname = "Patuakhali Science and Technology University " \
    "(PSTU)"
Config.profilename = "PSTU Eduroam Users"
Config.url = "your local eduroam® support page"
Config.email = "shahid@pstu.ac.bd"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.pstu.ac.bd"
...
Config.user_realm = "pstu.ac.bd"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam.pstu.ac.bd']
Config.use_other_tls_id = False
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
